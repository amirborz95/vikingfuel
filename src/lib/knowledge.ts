...
export const ARTICLES: KnowledgeArticle[] = [
  ...
  // ENERGI
  {
    slug: 'stress-och-trotthet',
    category: 'energi',
    title: 'Hur påverkar stress din energi?',
    metaDescription: 'Långvarig stress är en av de vanligaste orsakerna till trötthet. Så tömmer stress ditt energiförråd — och vad du kan göra.',
    keywords: ['stress trötthet', 'stress energi', 'utmattad av stress', 'stress orkeslös', 'hantera stress energi'],
    readingMinutes: 4,
    body: [
      { type: 'p', text: 'Stress i korta stötar är nyttigt — det gör dig alert. Men långvarig stress utan återhämtning håller kroppen i högvarv och tömmer energin snabbare än den laddas.' },
      { type: 'h2', text: 'Kroppen i ständigt "kör-läge"' },
      { type: 'p', text: 'Under stress höjs stresshormonet kortisol. Under längre tid stör det sömn, matsmältning och humör — och gör dig utmattad även om du "bara" suttit stilla.' },
      { type: 'h2', text: 'Stress stör sömnen' },
      { type: 'p', text: 'Stress gör det svårare att somna och sova djupt, vilket ger sämre återhämtning och ännu lägre energi dagen efter — en ond spiral.' },
      { type: 'h2', text: 'Bryta mönstret' },
      { type: 'ul', items: [
        'Bygg in riktiga pauser — inte bara skärmbyte.',
        'Rörelse och dagsljus sänker stressnivån.',
        'Andningsövningar lugnar nervsystemet snabbt.',
        'Adaptogener som ashwagandha används traditionellt för stresshantering.',
      ] },
    ],
    faq: [
      { q: 'Kan stress göra mig trött även om jag inte gör något fysiskt?', a: 'Ja. Mental stress höjer kortisol och stör sömnen, vilket tömmer energin oavsett fysisk ansträngning.' },
    ],
    related: ['varfor-alltid-trott', 'utbrandhet-tecken', 'vad-ar-ashwagandha'],
  },
  {
    slug: 'energi-pa-morgonen',
    category: 'energi',
    title: 'Hur får man mer energi på morgonen?',
    metaDescription: 'Trög varje morgon? Så vaknar du piggare — enkla morgonvanor som ger energi utan att du behöver vara en morgonmänniska.',
    keywords: ['energi på morgonen', 'pigg på morgonen', 'trög på morgonen', 'vakna utvilad', 'morgonrutin energi'],
    readingMinutes: 4,
    body: [
      { type: 'p', text: 'Hur du vaknar sätter tonen för hela dagen. Trög start beror ofta på sömnkvalitet och de första minuternas vanor — båda går att påverka.' },
      { type: 'h2', text: 'Ljus direkt' },
      { type: 'p', text: 'Dagsljus tidigt talar om för kroppen att det är dag och stänger av sömnhormonet melatonin. Dra upp gardinerna eller gå ut några minuter.' },
      { type: 'h2', text: 'Vatten före kaffe' },
      { type: 'p', text: 'Efter en natts sömn är du lätt uttorkad. Ett glas vatten först ger ofta mer än den första koppen kaffe.' },
      { type: 'h2', text: 'Rör på kroppen' },
      { type: 'p', text: 'Några minuters rörelse eller stretch sätter igång cirkulationen och vakenheten. Det behöver inte vara ett träningspass.' },
      { type: 'h2', text: 'Grunden är kvällen innan' },
      { type: 'p', text: 'Piggast på morgonen blir den som sovit bra. Fasta läggtider och mindre skärm sent gör störst skillnad.' },
    ],
    related: ['battre-somn-mer-energi', 'vad-ger-energi-naturligt', 'hur-tar-man-viking-fuel'],
  },
  {
    slug: 'utbrandhet-tecken',
    category: 'energi',
    title: 'Tecken på att du är på väg mot utmattning',
    metaDescription: 'Utmattning smyger sig på. Här är de tidiga varningstecknen att ta på allvar — och vad du kan göra innan det går för långt.',
    keywords: ['tecken utmattning', 'utbrändhet symptom', 'på väg mot utmattning', 'utmattningssyndrom tidiga tecken', 'kronisk stress'],
    readingMinutes: 4,
    body: [
      { type: 'p', text: 'Utmattning kommer sällan plötsligt — den byggs upp under lång tid av stress utan tillräcklig återhämtning. Att känna igen de tidiga tecknen ger dig chansen att bromsa i tid.' },
      { type: 'h2', text: 'Vanliga tidiga tecken' },
      { type: 'ul', items: [
        'Ihållande trötthet som inte försvinner med vila.',
        'Sömnproblem trots att du är utmattad.',
        'Sämre minne och koncentration.',
        'Irritation, nedstämdhet eller likgiltighet.',
        'Fysiska symptom som huvudvärk och spänningar.',
      ] },
      { type: 'h2', text: 'Vad du kan göra tidigt' },
      { type: 'p', text: 'Prioritera sömn och riktig återhämtning, sänk kraven där du kan, och rör på dig i lagom dos. Att sätta gränser är inte lyx utan nödvändigt.' },
      { type: 'h2', text: 'Sök hjälp i tid' },
      { type: 'p', text: 'Känner du igen flera tecken som håller i sig — prata med vården. Utmattning tas på större allvar ju tidigare den fångas.' },
    ],
    faq: [
      { q: 'Vad är skillnaden mellan trött och utbränd?', a: 'Vanlig trötthet försvinner med vila. Vid begynnande utmattning kvarstår tröttheten trots vila och kombineras ofta med sömnproblem och sämre fokus.' },
    ],
    related: ['stress-och-trotthet', 'varfor-alltid-trott', 'battre-somn-mer-energi'],
  },
  {
    slug: 'koffein-fordelar-nackdelar',
    category: 'energi',
    title: 'Koffein: fördelar och nackdelar',
    metaDescription: 'Koffein ger energi men har baksidor. Här är för- och nackdelarna — och hur du använder kaffe smart utan krasch.',
    keywords: ['koffein fördelar nackdelar', 'är kaffe nyttigt', 'koffein biverkningar', 'hur mycket koffein', 'koffein sömn'],
    readingMinutes: 4,
    body: [
      { type: 'p', text: 'Koffein är världens mest använda stimulant — och det fungerar. Men som med det mesta handlar det om dos och timing.' },
      { type: 'h2', text: 'Fördelarna' },
      { type: 'ul', items: [
        'Ökar vakenhet och fokus tillfälligt.',
        'Kan förbättra fysisk prestation.',
        'Kaffe innehåller även antioxidanter.',
      ] },
      { type: 'h2', text: 'Nackdelarna' },
      { type: 'ul', items: [
        'Krasch när effekten avtar.',
        'Stör sömnen om det tas för sent — sitter kvar i många timmar.',
        'Kan ge hjärtklappning, oro och magbesvär vid höga doser.',
        'Tolerans byggs upp — du behöver mer för samma effekt.',
      ] },
      { type: 'h2', text: 'Smart användning' },
      { type: 'p', text: 'Håll dig till måttliga mängder och undvik koffein efter lunch. Vill du ha jämn energi senare på dagen är koffeinfria adaptogener ett alternativ som inte stör sömnen.' },
    ],
    related: ['energi-utan-koffein', 'battre-somn-mer-energi', 'naturlig-energiboost'],
  },

  // TESTOSTERON
  {
    slug: 'libido-och-testosteron',
    category: 'testosteron',
    title: 'Låg lust — kan det vara testosteron?',
    metaDescription: 'Minskad sexlust kan ha många orsaker, testosteron är en av dem. Här är sambandet och vad du kan göra.',
    keywords: ['låg libido', 'minskad sexlust', 'libido testosteron', 'låg lust man', 'testosteron sexlust'],
    readingMinutes: 4,
    body: [
      { type: 'p', text: 'Testosteron spelar en roll för sexlusten, men libido påverkas av mycket mer — stress, sömn, relation, mediciner och allmän hälsa. Låg lust betyder inte automatiskt lågt testosteron.' },
      { type: 'h2', text: 'Vanliga orsaker till låg lust' },
      { type: 'ul', items: [
        'Stress och trötthet.',
        'Dålig sömn.',
        'Låg testosteronnivå.',
        'Vissa mediciner och livsstilsfaktorer.',
      ] },
      { type: 'h2', text: 'Vad kan du göra?' },
      { type: 'p', text: 'Börja med sömn, stresshantering och rörelse — det påverkar både libido och hormonbalans. Zink bidrar till en normal testosteronhalt och normal fertilitet.' },
      { type: 'h2', text: 'När söka hjälp?' },
      { type: 'p', text: 'Om låg lust håller i sig och påverkar dig, ta upp det med läkare — det kan vara värt att kolla testosteron och andra faktorer.' },
    ],
    faq: [
      { q: 'Betyder låg sexlust att jag har lågt testosteron?', a: 'Inte nödvändigtvis. Libido påverkas av stress, sömn, relation och hälsa. Testosteron är en faktor men sällan den enda.' },
    ],
    related: ['tecken-pa-lagt-testosteron', 'zink-och-testosteron', 'vad-ar-testosteron'],
  },
  {
    slug: 'bygga-muskler-testosteron',
    category: 'testosteron',
    title: 'Testosteron och muskeluppbyggnad',
    metaDescription: 'Testosteron är en nyckelfaktor för muskeltillväxt. Här är hur det hänger ihop och hur du stöttar både muskler och hormoner.',
    keywords: ['testosteron muskler', 'bygga muskler testosteron', 'muskeltillväxt hormon', 'testosteron styrka', 'muskelmassa'],
    readingMinutes: 4,
    body: [
      { type: 'p', text: 'Testosteron är ett av de viktigaste hormonerna för att bygga och behålla muskelmassa. Det påverkar proteinsyntesen — kroppens förmåga att bygga ny muskel.' },
      { type: 'h2', text: 'Hur hänger det ihop?' },
      { type: 'p', text: 'Högre testosteron underlättar muskeluppbyggnad och styrka. Det är en anledning till att män generellt bygger muskler lättare än kvinnor, och att nivån spelar roll även inom det normala spannet.' },
      { type: 'h2', text: 'Stötta båda samtidigt' },
      { type: 'p', text: 'Tung styrketräning, tillräckligt med protein, sömn och återhämtning bygger muskler och stöttar en normal testosteronnivå på samma gång.' },
      { type: 'h2', text: 'Näringens roll' },
      { type: 'p', text: 'Zink bidrar till en normal testosteronhalt, och tillräckligt med protein och energi är byggstenarna. Helheten avgör resultatet.' },
    ],
    related: ['traning-och-testosteron', 'kosttillskott-for-traning', 'zink-och-testosteron'],
  },
  {
    slug: 'stress-kortisol-testosteron',
    category: 'testosteron',
    title: 'Hur stress och kortisol påverkar testosteron',
    metaDescription: 'Kronisk stress och högt kortisol kan sänka testosteronet. Här är sambandet och hur du bryter den negativa spiralen.',
    keywords: ['kortisol testosteron', 'stress testosteron', 'kortisol sänker testosteron', 'stresshormon', 'stress hormonbalans'],
    readingMinutes: 3,
    body: [
      { type: 'p', text: 'Kortisol är kroppens främsta stresshormon. Kortsiktigt är det nyttigt, men kroniskt förhöjt kortisol kan påverka testosteronnivån negativt — hormonerna drar delvis åt olika håll.' },
      { type: 'h2', text: 'Balansen mellan kortisol och testosteron' },
      { type: 'p', text: 'När kroppen befinner sig i ständigt stressläge prioriteras överlevnad framför uppbyggnad. Det kan gå ut över processer som bygger muskler och stöttar en normal testosteronnivå.' },
      { type: 'h2', text: 'Sänk kortisolet naturligt' },
      { type: 'ul', items: [
        'Prioritera sömn — den viktigaste faktorn.',
        'Bygg in återhämtning och undvik överträning.',
        'Rörelse och tid utomhus.',
        'Adaptogener som ashwagandha används traditionellt för stresshantering.',
      ] },
    ],
    related: ['stress-och-trotthet', 'somn-och-testosteron', 'naturligt-oka-testosteron'],
  },
  {
    slug: 'testosteron-myter',
    category: 'testosteron',
    title: 'Vanliga myter om testosteron',
    metaDescription: 'Det florerar mycket felaktigt om testosteron. Här reder vi ut de vanligaste myterna — vad som stämmer och inte.',
    keywords: ['myter testosteron', 'testosteron fakta', 'sanningen om testosteron', 'testosteron missförstånd', 'testo booster fungerar'],
    readingMinutes: 4,
    body: [
      { type: 'p', text: 'Testosteron är omgivet av myter, halvsanningar och överdrivna marknadsföringspåståenden. Här reder vi ut några av de vanligaste.' },
      { type: 'h2', text: 'Myt: Ett tillskott kan dubbla ditt testosteron' },
      { type: 'p', text: 'Inget lagligt kosttillskott gör så. Zink kan stötta en normal nivå om du har brist, men det trollar inte fram testosteron hos den som redan ligger normalt.' },
      { type: 'h2', text: 'Myt: Bara gamla män har lågt testosteron' },
      { type: 'p', text: 'Nivån sjunker med åldern, men dålig sömn, stress och övervikt kan ge låga nivåer även hos unga.' },
      { type: 'h2', text: 'Myt: Mer testosteron är alltid bättre' },
      { type: 'p', text: 'Det handlar om en normal, hälsosam nivå — inte om att maximera. Onaturligt höga nivåer (t.ex. via missbruk av anabola) medför risker.' },
      { type: 'h2', text: 'Vad som faktiskt fungerar' },
      { type: 'p', text: 'Sömn, styrketräning, hälsosam vikt och tillräckligt av zink. Tråkigt men sant — grunderna slår genvägarna.' },
    ],
    related: ['vad-ar-testosteron', 'naturligt-oka-testosteron', 'kosttillskott-som-fungerar'],
  },

  // INGREDIENSER
  {
    slug: 'vad-ar-rhodiola',
    category: 'ingredienser',
    title: 'Vad är Rhodiola rosea?',
    metaDescription: 'Rhodiola rosea är en adaptogen som använts för uthållighet vid stress. Här är vad örten är och hur den används.',
    keywords: ['rhodiola rosea', 'vad är rhodiola', 'rosenrot', 'rhodiola effekt', 'rhodiola adaptogen'],
    readingMinutes: 3,
    body: [
      { type: 'p', text: 'Rhodiola rosea, även kallad rosenrot, är en växt som trivs i kalla bergstrakter — bland annat i Skandinavien. Den räknas som en adaptogen.' },
      { type: 'h2', text: 'Traditionell användning' },
      { type: 'p', text: 'Rhodiola har traditionellt använts för att stötta mental och fysisk uthållighet vid stress och trötthet, historiskt av bland annat vikingar och folk i nordliga områden.' },
      { type: 'h2', text: 'Vad studeras?' },
      { type: 'p', text: 'Rhodiola har undersökts i samband med upplevd trötthet, stress och prestation. Som med andra adaptogener varierar effekterna mellan individer.' },
    ],
    related: ['vad-ar-adaptogener', 'vad-ar-ashwagandha', 'stress-och-trotthet'],
  },
  {
    slug: 'panax-ginseng-vs-sibirisk',
    category: 'ingredienser',
    title: 'Panax ginseng vs sibirisk ginseng — vad är skillnaden?',
    metaDescription: 'Panax ginseng och sibirisk ginseng är olika växter med olika innehåll. Här är skillnaden och vilken som är vad.',
    keywords: ['panax ginseng', 'sibirisk ginseng', 'ginseng skillnad', 'eleuthero', 'äkta ginseng'],
    readingMinutes: 3,
    body: [
      { type: 'p', text: 'Ordet "ginseng" används om flera olika växter, vilket skapar förvirring. De två vanligaste är Panax ginseng och sibirisk ginseng — men de är faktiskt olika växter.' },
      { type: 'h2', text: 'Panax ginseng' },
      { type: 'p', text: 'Den "äkta" ginsengen (koreansk/asiatisk). Den mest studerade sorten, känd för sina så kallade ginsenosider, och den som oftast avses i kvalitetstillskott.' },
      { type: 'h2', text: 'Sibirisk ginseng (eleuthero)' },
      { type: 'p', text: 'En annan växt (Eleutherococcus senticosus) med liknande traditionell användning men annat innehåll. Den innehåller inte samma ginsenosider.' },
      { type: 'h2', text: 'Vilken ska man välja?' },
      { type: 'p', text: 'För den som vill ha den klassiska, mest studerade ginsengen är Panax ginseng valet. Kolla alltid vilken sort som anges på etiketten.' },
    ],
    related: ['vad-ar-ginseng', 'vad-ar-adaptogener', 'mental-skarpa'],
  },
  {
    slug: 'piperin-svartpeppar',
    category: 'ingredienser',
    title: 'Vad är piperin och varför finns det i tillskott?',
    metaDescription: 'Piperin från svartpeppar hjälper kroppen ta upp andra ämnen bättre. Här är varför det ofta ingår i kosttillskott.',
    keywords: ['piperin', 'svartpeppar extrakt', 'piperin upptag', 'bioperine', 'piperin kosttillskott'],
    readingMinutes: 3,
    body: [
      { type: 'p', text: 'Piperin är det aktiva ämnet i svartpeppar. I kosttillskott finns det inte för smakens skull, utan för att det kan förbättra kroppens upptag av vissa andra ämnen.' },
      { type: 'h2', text: 'Varför piperin?' },
      { type: 'p', text: 'Piperin har visats kunna öka biotillgängligheten — hur mycket kroppen faktiskt tar upp — av vissa näringsämnen och växtextrakt. Därför läggs en liten mängd ofta till i formler.' },
      { type: 'h2', text: 'Liten men smart ingrediens' },
      { type: 'p', text: 'Det handlar om små mängder, ofta standardiserat extrakt. Syftet är att du ska få ut mer av de övriga ingredienserna.' },
    ],
    related: ['vad-innehaller-viking-fuel', 'kosttillskott-som-fungerar', 'naturligt-vs-syntetiskt'],
  },
  {
    slug: 'vad-ar-bor-boron',
    category: 'ingredienser',
    title: 'Vad är bor (boron) och vad gör det?',
    metaDescription: 'Bor är ett spårämne som studerats i samband med hormoner och benhälsa. Här är vad bor är och var det finns.',
    keywords: ['bor mineral', 'boron', 'vad är bor', 'boron testosteron', 'bor kosttillskott'],
    readingMinutes: 3,
    body: [
      { type: 'p', text: 'Bor (boron) är ett spårämne som kroppen behöver i mycket små mängder. Det har fått ökat intresse inom kosttillskott, särskilt i formler riktade mot män.' },
      { type: 'h2', text: 'Vad gör bor?' },
      { type: 'p', text: 'Bor har studerats i samband med benhälsa och hormonbalans. Forskningen är fortfarande begränsad, men mineralet ses som en intressant komponent i vissa formler.' },
      { type: 'h2', text: 'Var finns bor?' },
      { type: 'p', text: 'Frukt (särskilt russin och plommon), nötter och baljväxter. De flesta får i sig små mängder via kosten.' },
    ],
    related: ['zink-och-testosteron', 'selen-fordelar', 'vad-innehaller-viking-fuel'],
  },

  // PRESTATION
  {
    slug: 'traningsvark-aterhamtning',
    category: 'prestation',
    title: 'Så snabbar du på återhämtningen efter träning',
    metaDescription: 'Bättre återhämtning = bättre resultat och mindre träningsvärk. Här är vad som faktiskt hjälper kroppen att bygga upp sig.',
    keywords: ['återhämtning träning', 'träningsvärk', 'snabbare återhämtning', 'muskelåterhämtning', 'vila efter träning'],
    readingMinutes: 4,
    body: [
      { type: 'p', text: 'Du blir inte starkare under passet — du blir starkare när du återhämtar dig efteråt. Bra återhämtning är därför lika viktig som själva träningen.' },
      { type: 'h2', text: 'Sömn först' },
      { type: 'p', text: 'Det mesta av kroppens reparation sker under sömnen. Prioriterar du inte sömnen begränsar du dina resultat.' },
      { type: 'h2', text: 'Näring för uppbyggnad' },
      { type: 'p', text: 'Tillräckligt med protein ger byggstenar, och mineraler som zink och magnesium stöttar muskelfunktion och återhämtning.' },
      { type: 'h2', text: 'Aktiv vila' },
      { type: 'p', text: 'Lätt rörelse, promenader och rörlighet mellan hårda pass ökar cirkulationen och kan minska stelhet bättre än total stillasittning.' },
    ],
    related: ['kosttillskott-for-traning', 'magnesium-fordelar', 'battre-somn-mer-energi'],
  },
  {
    slug: 'energi-innan-traning',
    category: 'prestation',
    title: 'Vad ska man äta och ta innan träning?',
    metaDescription: 'Rätt bränsle före passet ger mer ork. Här är vad du bör äta innan träning — och vad som är onödigt.',
    keywords: ['äta innan träning', 'pre workout', 'energi innan gym', 'mat före träning', 'bränsle träning'],
    readingMinutes: 4,
    body: [
      { type: 'p', text: 'Vad du får i dig innan träningen påverkar hur mycket du orkar. Målet är stabil energi — inte en snabb topp följd av en dipp mitt i passet.' },
      { type: 'h2', text: 'Timing' },
      { type: 'p', text: 'En större måltid 2–3 timmar innan, eller ett lättare mellanmål 30–60 minuter innan. Träna inte helt fastande om du vill ha maximal ork.' },
      { type: 'h2', text: 'Vad du bör äta' },
      { type: 'ul', items: [
        'Långsamma kolhydrater för jämn energi.',
        'Lite protein för musklerna.',
        'Undvik för mycket fett och fibrer precis innan (tungt i magen).',
      ] },
      { type: 'h2', text: 'Behövs "pre workout"?' },
      { type: 'p', text: 'Inte nödvändigtvis. Många färdiga pre workout-produkter är mest koffein och färg. Riktig mat och vatten räcker långt; koffeinfria alternativ finns för den som vill undvika kraschen.' },
    ],
    related: ['kosttillskott-for-traning', 'energi-nar-man-tranar', 'traningsvark-aterhamtning'],
  },
  {
    slug: 'fokus-vid-studier',
    category: 'prestation',
    title: 'Fokus och energi vid studier och plugg',
    metaDescription: 'Så håller du fokus och energi uppe när du pluggar — utan att bränna ut dig på kaffe och nattmackor.',
    keywords: ['fokus plugg', 'energi studier', 'plugga bättre', 'koncentration studier', 'orka plugga'],
    readingMinutes: 4,
    body: [
      { type: 'p', text: 'Att plugga effektivt handlar mer om jämn energi och smart upplägg än om att sitta längst. Här är grunderna för att orka och komma ihåg mer.' },
      { type: 'h2', text: 'Plugga i intervaller' },
      { type: 'p', text: 'Fokuserade pass på 25–50 minuter med korta pauser (t.ex. pomodoro) slår att stirra i boken i timmar. Hjärnan behöver mikropauser.' },
      { type: 'h2', text: 'Bränsle för hjärnan' },
      { type: 'p', text: 'Hoppa inte över måltider. Jämnt blodsocker håller fokus stabilt; drick vatten och undvik för mycket socker och energidryck.' },
      { type: 'h2', text: 'Sömn slår nattpluggande' },
      { type: 'p', text: 'Att sova är en del av inlärningen — minnen befästs under sömnen. En utvilad hjärna lär sig snabbare än en trött som pluggat hela natten.' },
    ],
    related: ['battre-fokus-naturligt', 'mental-skarpa', 'hjarndimma-brain-fog'],
  },

  // KOSTTILLSKOTT
  {
    slug: 'hur-lasa-innehallsforteckning',
    category: 'kosttillskott',
    title: 'Så läser du en innehållsförteckning på kosttillskott',
    metaDescription: 'Lär dig läsa etiketten på ett kosttillskott — så ser du direkt om produkten är bra eller mest fyllnad och marknadsföring.',
    keywords: ['läsa innehållsförteckning', 'etikett kosttillskott', 'ingredienser tillskott', 'proprietary blend', 'välja tillskott etikett'],
    readingMinutes: 4,
    body: [
      { type: 'p', text: 'Etiketten avslöjar det mesta om en produkts kvalitet — om du vet vad du ska titta efter. Här är en snabbguide.' },
      { type: 'h2', text: 'Titta efter tydliga mängder' },
      { type: 'p', text: 'Ett bra tillskott anger exakt hur mycket av varje ingrediens du får. Se upp med "proprietary blends" där bara totalvikten anges — då döljs de enskilda doserna.' },
      { type: 'h2', text: 'Rätt form av ingredienser' },
      { type: 'p', text: 'Formen spelar roll för upptaget — t.ex. zinkbisglycinat tas ofta upp bättre än billigare former. Standardiserade extrakt (med angiven halt aktivt ämne) är ett gott tecken.' },
      { type: 'h2', text: 'Undvik onödigt' },
      { type: 'ul', items: [
        'Långa listor av fyllnadsmedel.',
        'Överdrivna eller vaga påståenden.',
        'Ingredienser i minimala "pixie dust"-doser.',
      ] },
    ],
    faq: [
      { q: 'Vad är en proprietary blend?', a: 'En blandning där bara den totala mängden anges, inte hur mycket av varje ingrediens. Det gör det omöjligt att bedöma doserna — var skeptisk.' },
    ],
    related: ['kosttillskott-som-fungerar', 'gmp-certifierat', 'ar-kosttillskott-sakra'],
  },
  {
    slug: 'nar-pa-dagen-ta-tillskott',
    category: 'kosttillskott',
    title: 'När på dagen ska man ta kosttillskott?',
    metaDescription: 'Timing kan påverka effekt och upptag. Här är en enkel guide till när på dagen olika kosttillskott bäst tas.',
    keywords: ['när ta kosttillskott', 'timing kosttillskott', 'ta vitaminer på morgonen', 'kosttillskott med mat', 'bäst tid tillskott'],
    readingMinutes: 3,
    body: [
      { type: 'p', text: 'För de flesta tillskott är regelbundenhet viktigare än exakt klockslag. Men viss timing kan förbättra upptag och passa dygnsrytmen.' },
      { type: 'h2', text: 'Med eller utan mat?' },
      { type: 'p', text: 'Fettlösliga vitaminer (A, D, E, K) tas upp bäst tillsammans med mat som innehåller fett. Många mineraler och extrakt tas också med fördel i samband med en måltid för att vara skonsamma mot magen.' },
      { type: 'h2', text: 'Morgon eller kväll?' },
      { type: 'p', text: 'Energigivande och fokushöjande tillskott (t.ex. ginseng) passar ofta på morgonen eller förmiddagen. Lugnande som magnesium tas gärna på kvällen.' },
      { type: 'h2', text: 'Regelbundenhet framför allt' },
      { type: 'p', text: 'Adaptogener ger ofta mest nytta vid daglig, kontinuerlig användning. Välj en tidpunkt du kommer ihåg och håll dig till den.' },
    ],
    related: ['hur-tar-man-viking-fuel', 'kombinera-kosttillskott', 'kosttillskott-som-fungerar'],
  },
  {
    slug: 'kombinera-kosttillskott',
    category: 'kosttillskott',
    title: 'Kan man kombinera flera kosttillskott?',
    metaDescription: 'Får man ta flera tillskott samtidigt? Här är vad som går bra ihop, vad man bör tänka på och när man ska vara försiktig.',
    keywords: ['kombinera kosttillskott', 'flera tillskott samtidigt', 'ta flera vitaminer', 'tillskott interaktion', 'stacka kosttillskott'],
    readingMinutes: 4,
    body: [
      { type: 'p', text: 'De flesta vanliga kosttillskott går bra att kombinera, och en genomtänkt formel gör ofta jobbet åt dig. Men det finns saker att tänka på.' },
      { type: 'h2', text: 'Färre burkar, smartare' },
      { type: 'p', text: 'En bra samlingsformel med rätt ingredienser är ofta smidigare än många enskilda burkar — mindre risk att dubblera och lättare att komma ihåg.' },
      { type: 'h2', text: 'Se upp för dubblering' },
      { type: 'p', text: 'Tar du flera produkter kan du råka få i dig för mycket av samma ämne (t.ex. zink eller D-vitamin). Räkna ihop totalen och håll dig inom rekommenderade nivåer.' },
      { type: 'h2', text: 'Mediciner och sjukdom' },
      { type: 'p', text: 'Vissa tillskott kan påverka mediciner. Tar du receptbelagda läkemedel eller har en sjukdom — stäm av med läkare eller apotek.' },
    ],
    faq: [
      { q: 'Är det farligt att ta flera kosttillskott?', a: 'Oftast inte, men risken är att dubblera samma ämne och överskrida rekommenderade doser. Räkna ihop totalen och rådgör vid mediciner.' },
    ],
    related: ['nar-pa-dagen-ta-tillskott', 'ar-kosttillskott-sakra', 'kosttillskott-for-man'],
  },

  // VIKING FUEL
  {
    slug: 'viking-fuel-vs-energidryck',
    category: 'vikingfuel',
    title: 'Viking Fuel vs energidryck — vad är skillnaden?',
    metaDescription: 'Energidryck ger en snabb koffeinkick och krasch. Så skiljer sig Viking Fuel — jämn energi utan socker och koffein.',
    keywords: ['viking fuel vs energidryck', 'alternativ till energidryck', 'energidryck nackdelar', 'nyttig energi', 'energidryck vs kosttillskott'],
    readingMinutes: 3,
    body: [
      { type: 'p', text: 'Energidryck och Viking Fuel löser olika problem. Den ena ger en snabb, kortvarig kick; den andra stöttar en jämnare energi över tid.' },
      { type: 'h2', text: 'Energidryck' },
      { type: 'p', text: 'Bygger på koffein och ofta socker. Ger en snabb topp — följt av en krasch och risk för störd sömn om det tas sent. Höga mängder kan ge hjärtklappning och oro.' },
      { type: 'h2', text: 'Viking Fuel' },
      { type: 'p', text: 'Koffeinfritt och sockerfritt. Bygger på adaptogener (maca, ashwagandha, ginseng) och zink för att stötta naturlig energi, fokus och en normal testosteronhalt — utan kraschen.' },
      { type: 'h2', text: 'Vilket ska du välja?' },
      { type: 'p', text: 'Vill du ha en tillfällig kick finns energidryck. Vill du ha jämn energi i vardagen utan sömnstörningar och krasch är ett koffeinfritt tillskott ett bättre val.' },
    ],
    related: ['energi-utan-koffein', 'koffein-fordelar-nackdelar', 'varfor-viking-fuel'],
  },
  {
    slug: 'for-vem-passar-viking-fuel',
    category: 'vikingfuel',
    title: 'För vem passar Viking Fuel?',
    metaDescription: 'Är Viking Fuel något för dig? Här är vem produkten är gjord för — och vem den inte passar.',
    keywords: ['för vem viking fuel', 'passar viking fuel mig', 'vem ska ta viking fuel', 'viking fuel målgrupp'],
    readingMinutes: 3,
    body: [
      { type: 'p', text: 'Viking Fuel är utvecklat för dig som vill ha jämn energi, fokus och vitalitet i vardagen — utan koffeinkrasch och utan en hel hylla med burkar.' },
      { type: 'h2', text: 'Passar bra för dig som…' },
      { type: 'ul', items: [
        'Känner dig trött eller seg mitt på dagen.',
        'Vill ha energi utan koffein och socker.',
        'Tränar och vill stötta uthållighet och en normal hormonbalans.',
        'Föredrar en ren, transparent formel framför många produkter.',
      ] },
      { type: 'h2', text: 'Passar mindre bra om…' },
      { type: 'p', text: 'Du är gravid eller ammar, tar receptbelagda mediciner eller har en sjukdom — då bör du rådgöra med läkare först. Kosttillskott ersätter inte en varierad kost och hälsosam livsstil.' },
    ],
    faq: [
      { q: 'Är Viking Fuel bara för män?', a: 'Formeln riktar sig särskilt till män (bl.a. via zink för normal testosteronhalt), men adaptogenerna för energi och fokus är relevanta för de flesta vuxna.' },
    ],
    related: ['varfor-viking-fuel', 'viking-fuel-vs-energidryck', 'vad-innehaller-viking-fuel'],
  },
];
