...
export default function ContactContent() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // Submit to Netlify Forms. The POST must target the static skeleton file
    // (/__forms.html), not "/", because the Next.js SSR handler would otherwise
    // intercept "/" and the request would never reach Netlify's form processing.
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-muted/30 rounded-2xl p-8">
            ...
            >
              ...
              <p className="hidden">
                <label>
                  Lämna tomt: <input name="bot-field" />
                </label>
              </p>
              <div>
