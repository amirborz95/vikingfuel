...
export default function ProductDetailView({ initialBundle = 0 }: { initialBundle?: number }) {
  ...
  const bundles = [
    { id: 'bundle-1', label: 'Testo-support', sublabel: en ? '60 capsules' : '60 kapslar', price: 349, oldPrice: 0, image: '/assets/images/viking-energy-1e.png', priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_1 || '', imageAlt: 'Single Viking Fuel supplement bottle on white background', tag: null as string | null, units: 1 },
    { id: 'bundle-2', label: 'Testo-support 3-pack', sublabel: en ? '180 capsules' : '180 kapslar', price: 942, oldPrice: 1047, image: '/assets/images/viking-energy-3e.png', priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_3 || '', imageAlt: 'Three Viking Fuel supplement bottles on white background', tag: en ? '10% discount' : '10% rabatt', units: 3 },
    { id: 'bundle-3', label: 'Testo-support 6-pack', sublabel: en ? '360 capsules' : '360 kapslar', price: 1674, oldPrice: 2094, image: '/assets/images/viking-energy-6e.png', priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_6 || '', imageAlt: 'Six Viking Fuel supplement bottles on white background', tag: en ? '20% discount' : '20% rabatt', units: 6 },
  ];
