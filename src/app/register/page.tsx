            ...
            <div className="container-wide">
              <div className="max-w-3xl mx-auto">
                <div className="text-center mb-10">
                  <h1 className="text-4xl font-extrabold text-foreground mb-4">Skapa konto</h1>
                  <p className="text-lg text-muted-foreground">
                    Registrera dig för att spara beställningar, se orderstatus och få personliga erbjudanden.
                  </p>
                </div>
